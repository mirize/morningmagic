...
import 'package:morningmagic/pages/exercises/stanrart/screenExerciseEight.dart';
...
class ExerciseSevenScreen extends StatefulWidget {
  @override
  State createState() {
    return ExerciseSevenScreenState();
  }
}

class ExerciseSevenScreenState extends State<ExerciseSevenScreen> {
  ...
  Widget build(BuildContext context) {
    timerAppBar =
        TimerAppBar(AppLocalizations.of(context).translate("exercise_7_title"));
    return SafeArea(
      child: WillPopScope(
                    ...
                    Positioned(
                        ...
                        child:
                          ...
                          if (result) {
                            ...
                            assetsAudioPlayer.open(
                              Audio(AppLocalizations.of(context)
                                  .translate("exercise_seven_sound")),
                            );
                          } else {
                            // woman voice
                            assetsAudioPlayer.open(
                              Audio("assets/audios/7w.mp3"),
                            );
                          }
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ExerciseEightScreen()));
