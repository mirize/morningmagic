...
import 'package:morningmagic/pages/exercises/stanrart/screenExerciseFive.dart';
...
class ExerciseFourScreen extends StatefulWidget {
  @override
  State createState() {
    return ExerciseFourScreenState();
  }
}

class ExerciseFourScreenState extends State<ExerciseFourScreen> {
                    ...
                    Positioned(
                        ...
                        child:
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ExerciseFiveScreen()));
