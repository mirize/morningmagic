...
import 'package:morningmagic/pages/exercises/stanrart/screenExerciseThree.dart';
...
class ExerciseTwoScreen extends StatefulWidget {
  @override
  State createState() {
    return ExerciseTwoScreenState();
  }
}

class ExerciseTwoScreenState extends State<ExerciseTwoScreen> {
                    ...
                    Positioned(
                        ...
                        child:
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ExerciseThreeScreen()));
