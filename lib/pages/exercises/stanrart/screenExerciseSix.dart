...
import 'package:morningmagic/pages/exercises/stanrart/screenExerciseSeven.dart';
...
class ExerciseSixScreen extends StatefulWidget {
  @override
  State createState() {
    return ExerciseSixScreenState();
  }
}

class ExerciseSixScreenState extends State<ExerciseSixScreen> {
  ...
  Widget build(BuildContext context) {
    timerAppBar =
        TimerAppBar(AppLocalizations.of(context).translate("exercise_6_title"));
    return SafeArea(
      child: WillPopScope(
                    ...
                    Positioned(
                        ...
                        child:
                          ...
                          if (result) {
                            ...
                            assetsAudioPlayer.open(
                              Audio(AppLocalizations.of(context)
                                  .translate("exercise_six_sound")),
                            );
                          } else {
                            // woman voice
                            assetsAudioPlayer.open(
                              Audio("assets/audios/6w.mp3"),
                            );
                          }
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ExerciseSevenScreen()));
