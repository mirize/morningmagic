...
import 'package:morningmagic/pages/exercises/stanrart/screenExerciseNine.dart';
...
class ExerciseEightScreen extends StatefulWidget {
  @override
  State createState() {
    return ExerciseEightScreenState();
  }
}

class ExerciseEightScreenState extends State<ExerciseEightScreen> {
                  ...
                  Positioned(
                      ...
                      child: BottomExerciseNavigation(soundCallback: () async {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ExerciseNineScreen()));
