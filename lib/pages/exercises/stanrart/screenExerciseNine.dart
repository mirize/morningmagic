...
import 'package:morningmagic/pages/exercises/stanrart/screenExerciseTen.dart';
...
class ExerciseNineScreen extends StatefulWidget {
  @override
  State createState() {
    return ExerciseNineScreenState();
  }
}

class ExerciseNineScreenState extends State<ExerciseNineScreen> {
  ...
  Widget build(BuildContext context) {
    timerAppBar =
        TimerAppBar(AppLocalizations.of(context).translate("exercise_9_title"));
    return SafeArea(
      child: WillPopScope(
                    ...
                    Positioned(
                        ...
                        child:
                          ...
                          if (result) {
                            ...
                            assetsAudioPlayer.open(
                              Audio(AppLocalizations.of(context)
                                  .translate("exercise_nine_sound")),
                            );
                          } else {
                            // woman voice
                            assetsAudioPlayer.open(
                              Audio("assets/audios/9w.mp3"),
                            );
                          }
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ExerciseTenScreen()));
