...
class DynamicExerciseSixScreen extends StatefulWidget {
  @override
  State createState() {
    return DynamicExerciseSixScreenState();
  }
}

class DynamicExerciseSixScreenState extends State<DynamicExerciseSixScreen> {
