...
class DynamicExerciseOneScreen extends StatefulWidget {
  @override
  State createState() {
    return DynamicExerciseOneScreenState();
  }
}

class DynamicExerciseOneScreenState extends State<DynamicExerciseOneScreen> {
