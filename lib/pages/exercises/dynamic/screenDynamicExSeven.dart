...
class DynamicExerciseSevenScreen extends StatefulWidget {
  @override
  State createState() {
    return DynamicExerciseSevenScreenState();
  }
}

class DynamicExerciseSevenScreenState
    extends State<DynamicExerciseSevenScreen> {
